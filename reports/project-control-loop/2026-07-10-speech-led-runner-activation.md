...
- install root: `/Users/operator/.local/share/actions-runner/video-os-media`
...
The runner uses a private, local, rights-cleared derived fixture at `/Users/operator/.local/share/video-os-fixtures/lively-alt-vol5-regression`. It is based on the operator-approved `lively-alt-vol5` golden render with the approved 60px captions. Canonical brief, blueprint, review, state, and remapped timeline metadata are present only in that private fixture.
