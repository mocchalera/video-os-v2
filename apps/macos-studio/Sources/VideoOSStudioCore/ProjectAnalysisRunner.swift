...
public struct ProjectAnalysisRunOptions: Equatable, Sendable {
    ...
    public static let speechLedHighlightDefaults = ProjectAnalysisRunOptions(
        skipSTT: false,
        skipVLM: true,
        skipDiarize: true,
        skipPeak: false,
        ...
        skipPreflight: true,
        language: "ja",
        contentHint: "Japanese interview, seminar, or event dialogue for a 60-180 second speech-led highlight",
        concurrency: 1,
        noCache: false
    )
}
