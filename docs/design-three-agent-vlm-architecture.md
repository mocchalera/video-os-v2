...
The current Gemini VLM connector is a general segment-enrichment pass. Its prompt asks for `summary`, `tags`, `interest_points`, `quality_flags`, confidence, and `visual_quality` in one JSON response ([runtime/connectors/gemini-vlm.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/connectors/gemini-vlm.ts:24)). It accepts a bundle of frame paths plus text context through the provider-agnostic `VlmFn` interface ([runtime/connectors/gemini-vlm.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/connectors/gemini-vlm.ts:150)), normalizes quality flags and `visual_quality`, and defaults to `gemini-2.5-flash-lite` when no policy override is provided ([runtime/connectors/gemini-vlm.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/connectors/gemini-vlm.ts:652)).

The VLM stage groups segments by asset, skips unusable or too-short segments, runs Gemini with concurrency, and reduces successful shards back into `segments.json` and `assets.json` ([runtime/pipeline/stages/vlm.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/pipeline/stages/vlm.ts:237), [runtime/pipeline/stages/vlm.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/pipeline/stages/vlm.ts:363)). The reducer currently overwrites or enriches `summary`, `tags`, `quality_flags`, `interest_points`, `visual_quality`, confidence, and provenance ([runtime/pipeline/stages/vlm.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/pipeline/stages/vlm.ts:385)).
...
Marlin is already integrated as a local worker with two narrow calls: `caption(videoPath)` and `find(videoPath, event)` ([runtime/connectors/marlin-local.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/connectors/marlin-local.ts:38)). Its raw output shape includes `scene`, optional `caption`, and timestamped `events` ([runtime/connectors/marlin-types.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/connectors/marlin-types.ts:18)). The stage normalizes that into `03_analysis/marlin_events.json`, then applies overlapping events back to `segments.json` as `interest_points` and `peak_analysis` ([runtime/pipeline/stages/marlin.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/pipeline/stages/marlin.ts:122), [runtime/pipeline/stages/marlin.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/pipeline/stages/marlin.ts:174)).

The default policy already declares Marlin enabled, primary, and responsible for temporal semantics ([runtime/analysis-defaults.yaml](/Users/mocchalera/Dev/video-os-v2-spec/runtime/analysis-defaults.yaml:44)). The CLI currently runs the normal ingest/VLM pipeline first, then runs Marlin as a post-pass when enabled ([scripts/analyze.ts](/Users/mocchalera/Dev/video-os-v2-spec/scripts/analyze.ts:258), [scripts/analyze.ts](/Users/mocchalera/Dev/video-os-v2-spec/scripts/analyze.ts:278)).
...
The current blueprint agent is text-only and also defaults to `gemini-2.5-flash-lite` ([runtime/agents/llm-blueprint-agent.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/agents/llm-blueprint-agent.ts:24)). It compacts the brief and approved selects, then asks for an `EditBlueprint` JSON with beats, story arc, pacing, policies, candidate plans, and duration rules ([runtime/agents/llm-blueprint-agent.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/agents/llm-blueprint-agent.ts:157), [runtime/agents/llm-blueprint-agent.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/agents/llm-blueprint-agent.ts:218)). Its normalizer strips unknown fields, canonicalizes candidate refs, and fills defaults ([runtime/agents/llm-blueprint-agent.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/agents/llm-blueprint-agent.ts:765)).
