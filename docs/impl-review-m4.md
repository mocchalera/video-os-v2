...
- さらに engine_render 側の assembly は quarantine 済みの experimental stub のままで、pipeline は prebuilt `assembly.mp4` を必須化している。[composition.ts](/Users/mocchalera/Dev/video-os-v2-spec/runtime/render/__experimental/composition.ts) [runtime/render/pipeline.ts:293](/Users/mocchalera/Dev/video-os-v2-spec/runtime/render/pipeline.ts#L293)
