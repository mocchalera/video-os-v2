...
| `build_to_peak` | B-roll only fixture でも scene tension を作れる。`rokutaro-v3` の主戦場に近い |
...
- `rokutaro-v3` で `match_cut_bridge` / `silence_beat` / `build_to_peak` のいずれかが確認できる
...
- `projects/rokutaro-v3`
- `projects/rokutaro-v3-dialogue` (P1a 以降)
...
5. `projects/rokutaro-v3` で manual E2E が通り、少なくとも 1 つの skill-driven transition が確認できること
