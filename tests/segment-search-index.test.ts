        ...
        return {
          ...
          selects: {
            ...
            candidates: (segments.items ?? []).map((segment, index) => ({
              ...
              why_it_matches: `${segment.summary ?? segment.segment_id}; search result; morning light; hands detail; audible breathing; at least one spoken line about slowing down`,
              risks: [],
              confidence: 0.8,
              evidence: [
                "search:segment_text_index",
                "morning light",
                "hands detail",
                "audible breathing",
